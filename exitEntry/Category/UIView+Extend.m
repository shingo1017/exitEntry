...
- (void)borderStyle {
    ...
    [self borderStyleWithColor:rgba(240, 240, 240, 1)];
}
...
- (id)initWithScaledFrame:(CGRect)frame {
    ...
    return [[super init] initWithFrame:CGRectMake(frame.origin.x, frame.origin.y, floatByScale(frame.size.width), floatByScale(frame.size.height))];
}
