...
- (NSString *)pureUrl {
    ...
    if ([self containsString:@"duyao001.com"] || [self containsString:@"112.126.68.72"]) {
...
- (CGFloat)heightOfAttributedText:(NSAttributedString*)attributed width:(float)width {
    ...
    //获取设置文本间距以后的高度
    CGRect frame = [attributed boundingRectWithSize:CGSizeMake(width, MAXFLOAT) options:NSStringDrawingUsesLineFragmentOrigin context:nil];
...
- (CGSize)sizeOfFont:(UIFont *)font limitSize:(CGSize)size {
